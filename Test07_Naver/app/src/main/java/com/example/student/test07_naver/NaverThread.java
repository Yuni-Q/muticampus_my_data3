...
public class NaverThread extends Thread {
    ...
    @Override
    public void run() {
        String clientId = "Ln31lee7nt4XvdSU9VlY";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "Faz4Iwm6Bi";//애플리케이션 클라이언트 시크릿값";
        try {
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            // 결과 xml 문서 파싱해서 vo 객체로 만드는 작업 시작
